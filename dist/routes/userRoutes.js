...
import sendPasswordVerificationEmail from "../controllers/user/update/sendVerificationEmail.js";
import updateUserPassword from "../controllers/user/update/updatePassword.js";
import checkResetPasswordToken from "../middlewares/checkResetPasswordToken.js";
...
usersRouter.post('/password/verification', errorHandler(sendPasswordVerificationEmail));
usersRouter.post('/password/update', errorHandler(checkResetPasswordToken), errorHandler(updateUserPassword));
